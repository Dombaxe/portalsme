...
<div class="list-group mb-2">
    ...
    <div class="list-group">
        ...
        <a href="http://www.sme.gov.ao/salvoconduto/" class="list-group-item list-group-item-action active" style="text-shadow:2px 2px 3px rgba(117, 106, 106, 0.8);">Salvo-Conduto</a>
        <a href="http://www.sme.gov.ao/passetravessia/" class="list-group-item list-group-item-action list-group-item-my-color-5 text-my-color-5">Passe de Travessia</a>
