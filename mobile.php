      ...
      <section class="element-animate">
             ...
             <div> <a class="btn btn-light btn-sm search-dom" href="#" data-toggle="modal" data-target="#sitemodal"><i class="fa fa-search"></i></a></div>
                <div><a class="btn btn-primary btn-sm fb" href="https://www.facebook.com/servicodemigracaoestrangeiros"><i class="fa fa-facebook"></i></a></div>
                <div><a class="btn btn-danger btn-sm youtb" href="#"><i class="fa fa-youtube"></i></a></div>
                <div><?php
