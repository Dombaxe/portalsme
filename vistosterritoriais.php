<?php
/*
Template Name: vistos territoriais 
*/
?>
<?php get_header(); ?>
...
<div class="col-md-3 col-lg-3 mb-4">
     ...
     <div class="list-group mb-2">
         ...
         <div class="list-group">
            ...
            <a href="http://www.sme.gov.ao/vistosterritorial/" class="list-group-item list-group-item-action active">Visto Territoriais</a>
