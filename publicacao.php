...
<div class="col-md-3 col-lg-3 mb-4">
    ...
    <div class="list-group mb-2">
            ...
            <a href="http://www.sme.gov.ao/publicacao/" class="list-group-item list-group-item-action active" style="text-shadow:2px 2px 3px rgba(117, 106, 106, 0.8);">Publicações</a>
            <a href="http://www.sme.gov.ao/revistapassaporte/" class="list-group-item list-group-item-action list-group-item-my-color-5 text-my-color-5">Revista o Passaporte</a>
