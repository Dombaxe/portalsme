    ...
    <header class="fixed-top">
        <nav class="navbar navbar-expand-lg max-headera bg-white">
            ...
            <a class="navbar-brand col-12 logo d-sm-block d-md-none justify-content-center" href="https://www.sme.gov.ao/">
                    <img src="<?php bloginfo('template_url'); ?>/assets/SME GOV.ao MAUSC.png" width="350px" height="80px">                               
            </a>
          ...
          <nav class="navbar navbar-expand-lg navbar-white p-0" style="background: radial-gradient(208.79% 20249.73% at 0.9% 50.55%, #2F558C 0%, rgba(3, 210, 255, 0.66) 100%);">
